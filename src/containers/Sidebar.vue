     ...
     <div class="sidebar" @mouseenter="isMenuOver=true" @mouseleave="isMenuOver=false"  @touchstart="isMenuOver=true" >
        <div class="main-menu">
            <vue-perfect-scrollbar class="scroll" :settings="{ suppressScrollX: true, wheelPropagation: false }" >
                <ul class="list-unstyled">
                    ...
                    <li :class="{ active : selectedParentMenu==='dashboards' }"><a @click.prevent="openSubMenu($event,'dashboards')" href="#dashboards"><i class="iconsmind-Shop-4"></i>{{ $t("menu.dashboards") }}</a></li>
                   <li :class="{ active : selectedParentMenu==='layouts'}"><a @click.prevent="openSubMenu($event,'layouts')" href="#layouts"><i class="iconsmind-Digital-Drawing"></i>{{ $t("menu.layouts") }}</a></li>
                   <li :class="{ active : selectedParentMenu==='applications'}"><a @click.prevent="openSubMenu($event,'applications')" href="#applications"><i class="iconsmind-Air-Balloon"></i>{{ $t("menu.applications") }}</a></li>
                   <li :class="{ active : selectedParentMenu==='ui'}"><a @click.prevent="openSubMenu($event,'ui')" href="#ui"><i class="iconsmind-Pantone"></i>{{ $t("menu.ui") }}</a></li>
                   <li :class="{ active : selectedParentMenu==='landingpages'}"><a @click.prevent="openSubMenu($event,'landingpages')" href="#landingpages"><i class="iconsmind-Space-Needle"></i>{{ $t("menu.landingpages") }}</a></li>
                   <li :class="{ active : selectedParentMenu==='menu'}"><a @click.prevent="openSubMenu($event,'menu')" href="#menu"><i class="iconsmind-Three-ArrowFork"></i>{{ $t("menu.menu") }}</a></li> 
                   ...
                   <!-- Single Menu
                    <router-link :class="{ active : selectedParentMenu==='dashboards' }" @click.native="changeSelectedParentHasNoSubmenu('dashboards')" to="/app/dashboards/default" tag="li">
                      <a><i class="iconsmind-Digital-Drawing"></i>  {{ $t("menu.dashboards") }}</a>
                    </router-link>
                    <router-link :class="{ active : selectedParentMenu==='layouts' }" @click.native="changeSelectedParentHasNoSubmenu('layouts')" to="/app/layouts/data-list" tag="li">
                      <a><i class="iconsmind-Digital-Drawing"></i>  {{ $t("menu.layouts") }}</a>
                    </router-link>
        ...
        <div class="sub-menu">
             <vue-perfect-scrollbar class="scroll" :settings="{ suppressScrollX: true, wheelPropagation: false }" >
                ...
                <ul class="list-unstyled" data-link="layouts" :class="{'d-block':selectedParentMenu==='layouts' }">
                    <router-link tag="li" to="/app/layouts/data-list"><a><i class="simple-icon-credit-card"></i> {{ $t("menu.data-list") }}</a></router-link>
                    <router-link tag="li" to="/app/layouts/thumb-list"><a><i class="simple-icon-list"></i> {{ $t("menu.thumb-list") }}</a></router-link>
                    <router-link tag="li" to="/app/layouts/image-list"><a><i class="simple-icon-grid"></i> {{ $t("menu.image-list") }}</a></router-link>
                    <router-link tag="li" to="/app/layouts/details"><a><i class="simple-icon-book-open"></i> {{ $t("menu.details") }}</a></router-link>
                    <router-link tag="li" to="/app/layouts/search"><a><i class="simple-icon-magnifier"></i> {{ $t("menu.search") }}</a></router-link>
               ...
               <ul class="list-unstyled" data-link="landingpages" :class="{'d-block':selectedParentMenu==='landingpages' }">
                    <router-link tag="li" to="/multipage-home"><a target="_blank"><i class="simple-icon-docs"></i> {{ $t("menu.multipage-home") }}</a></router-link>
                    <router-link tag="li" to="/singlepage-home"><a target="_blank"><i class="simple-icon-doc"></i> {{ $t("menu.singlepage-home") }}</a></router-link>
                    <router-link tag="li" to="/about"><a target="_blank"><i class="simple-icon-info"></i> {{ $t("menu.about") }}</a></router-link>
                    <router-link tag="li" to="/auth-login"><a target="_blank"><i class="simple-icon-user-following"></i> {{ $t("menu.auth-login") }}</a></router-link>
                    <router-link tag="li" to="/auth-register"><a target="_blank"><i class="simple-icon-user-follow"></i> {{ $t("menu.auth-register") }}</a></router-link>
                    <router-link tag="li" to="/blog"><a target="_blank"><i class="simple-icon-bubbles"></i> {{ $t("menu.blog") }}</a></router-link>
                    <router-link tag="li" to="/blog-detail"><a target="_blank"><i class="simple-icon-bubble"></i> {{ $t("menu.blog-detail") }}</a></router-link>
                    <router-link tag="li" to="/careers"><a target="_blank"><i class="simple-icon-people"></i> {{ $t("menu.careers") }}</a></router-link>
                    <router-link tag="li" to="/confirmation"><a target="_blank"><i class="simple-icon-check"></i> {{ $t("menu.confirmation") }}</a></router-link>
                    <router-link tag="li" to="/contact"><a target="_blank"><i class="simple-icon-phone"></i> {{ $t("menu.contact") }}</a></router-link>
                    <router-link tag="li" to="/content"><a target="_blank"><i class="simple-icon-book-open"></i> {{ $t("menu.content") }}</a></router-link>
                    <router-link tag="li" to="/docs"><a target="_blank"><i class="simple-icon-notebook"></i> {{ $t("menu.docs") }}</a></router-link>
                    <router-link tag="li" to="/features"><a target="_blank"><i class="simple-icon-chemistry"></i> {{ $t("menu.features") }}</a></router-link>
                    <router-link tag="li" to="/prices"><a target="_blank"><i class="simple-icon-wallet"></i> {{ $t("menu.prices") }}</a></router-link>
                    <router-link tag="li" to="/videos"><a target="_blank"><i class="simple-icon-film"></i> {{ $t("menu.videos") }}</a></router-link>
                </ul>
