...
export default {
    ...
    data(){
      ...
      methods:{
        onResizeLandingPage() {
            var rowOffsetHome = document.querySelector(".home-row").offsetLeft;
            document.querySelector(".landing-page .section.home").style.backgroundPositionX=rowOffsetHome - 580 + "px";
        }
    },
    mounted(){
